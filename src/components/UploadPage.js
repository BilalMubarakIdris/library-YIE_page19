...
const UploadPage = () => {
    ...
    return (
        <>
            <section className='m-2 p-2 w-full border-2 border-gray-300 shadow bg-blue-100'>
                <h1 className='text-2xl p-2 text-white bg-gray-800 font-semibold mb-5 m-3'>Upload Data</h1>
